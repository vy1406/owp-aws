...
export const LANG = {
    EN: {
        ...
        ERROR_UPDATE_APPLICATION: "Error updating application",
        DELETE_APPLICATION_SUCCESS: "Application deleted successfully",
        ERROR_DELETE_APPLICATION: "Error deleting application",
        ...
        DELETE_APPLICATION_ERROR: "Error deleting application",
