        ...
        <div>
            ...
            >
                <svg width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M10.125 8.875C10.125 7.83947 10.9645 7 12 7C13.0355 7 13.875 7.83947 13.875 8.875C13.875 9.56245 13.505 10.1635 12.9534 10.4899C12.478 10.7711 12 11.1977 12 11.75V13" stroke="#4f46e5" strokeWidth="1.5" strokeLinecap="round" />
            ...
            {isOpen && (
                <div
                    id="modalContainer"
                    className="fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center w-screen h-screen"
                >
                    <div
                        ref={howToRef}
